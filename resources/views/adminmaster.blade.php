...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="public/admin/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="public/admin/bower_components/bootstrap-daterangepicker/daterangepicker.css">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="pubic/admin/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="pubic/admin/javascript:void(0)">
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
              Delete chat history
              <a href="public/admin/javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
